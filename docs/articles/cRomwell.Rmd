...
vignette: >
  %\VignetteIndexEntry{The cRomwell package}
...
workflow system. The
`[cRomwell](https://github.com/seandavi/cRomwell)` R package allows
users of the R statistical programming environment to interact with
the Cromwell workflow system. The cRomwell R package can act as the
